...
L0:
        ...
        iconst_1 ; instr_line 3 depth 1
        isub ; instr_line 4 depth -1
        istore 0 ; store to i instr_line 5 depth -1
L1:
        goto L3 ; instr_line 6 depth 0
L2:
        iload 0 ; load from i instr_line 7 depth 1
        ifne L0 ; instr_line 8 depth -1
        goto L3 ; instr_line 9 depth 0
L3:
